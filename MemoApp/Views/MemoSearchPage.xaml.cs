...
namespace MemoApp.Views
{
	...
	/// </summary>
	public sealed partial class MemoSearchPage : Page
	{
		public ViewModels.MemoSearchPageViewModel ViewModel { get; private set; } = new ViewModels.MemoSearchPageViewModel();
		public ViewModels.CommonViewModel Common { get; private set; } = new ViewModels.CommonViewModel();

		public MemoSearchPage()
		{
